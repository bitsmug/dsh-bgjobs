...
var require_gui_prefs = __commonJS({
  "lib/client-src/gui-prefs.js"(exports2, module2) {
    ...
    var DEFAULT_ELEMENTS = { settingsButton: true, onlySession: true, fullAccess: true, groupHeader: true, notify: true };
...
var require_ui = __commonJS({
  "lib/client-src/ui.js"(exports2, module2) {
    ...
    module2.exports = { stateColor, stateLabel, normalizePath, readActiveCwd, PANEL_Z, TOAST_Z, DONE_AGE_MS, GRIP_H, ToastComponent, iconEl, IconTrash, IconClock, IconClose, IconChevronDown, IconChevronRight, IconFolderOpen, IconFolderClose, IconSettings, SelfToast, CtrlBtn, MiniBtn, Toggle, portalBody, clampToViewport };
  }
});
...
var require_panel = __commonJS({
  "lib/client-src/panel.js"(exports2, module2) {
    ...
    var { stateColor, stateLabel, normalizePath, readActiveCwd, DONE_AGE_MS, PANEL_Z, TOAST_Z, GRIP_H, ToastComponent, iconEl, IconTrash, IconClock, IconClose, IconChevronDown, IconChevronRight, IconFolderOpen, IconFolderClose, IconSettings, SelfToast, CtrlBtn, MiniBtn, Toggle, portalBody, clampToViewport } = require_ui();
                    ...
                    return h(
                      ...
                      h(
                        ...
                        h(
                          ...
                          whereOf("name") === "list" ? h("div", { style: { fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, job.name) : null,
                          sec.length ? h(
                            "div",
  ...
  "lib/client-src/mcp-section.js"(exports2, module2) {
    ...
    function McpSettings({ t }) {
      ...
      return h(
        ...
        h(
          "div",
          { style: { display: "flex", alignItems: "center", gap: 10, padding: "8px 0 2px" } },
...
var require_settings_section = __commonJS({
  "lib/client-src/settings-section.js"(exports2, module2) {
    ...
    var ELEMENT_KEYS = ["settingsButton", "onlySession", "fullAccess", "groupHeader", "notify"];
    var SwitchC = null;
    try {
      SwitchC = require("@deepseek-ai/dsh-client-ui-primitives").Switch;
    } catch (e) {
    ...
    function SettingsSection({ t, guiPrefs, monitor }) {
      ...
      return h(
        ...
        // 行 6+：「MCP 任务」区块（总开关 + server 登记 + 从 DSH 导入，见 mcp-section.js）
        h(McpSettings, { t }),
